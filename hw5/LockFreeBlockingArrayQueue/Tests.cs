...
// Тесты тут очень похожи на тесты для LockBasedBlockingArrayQueue
// Можно их как-то объединить, передав просто нужный интерфейс очереди для тестирования? 
namespace LockFreeBlockingArrayQueue
{
    public class Tests
    {
        ...
        {
            const int n = 10;
            var emptyQueue = new LockFreeQueue<int>(n);
        ...
        {
            const int n = 10;
            var queue = new LockFreeQueue<int>(n);
